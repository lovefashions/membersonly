...
const HomePage = () => {
  ...
  const tiers = [{
    ...
    perks: ['Early looks at new content', 'Behind-the-scenes access', 'Members-only posts & updates', 'Community access']
  }, {
    name: 'VIP Lounge',
    price: '$45',
    period: '/mo',
    description: 'Elevate your experience with premium perks.',
    perks: ['All Fan Club perks', 'Early access to new content', 'Exclusive discounts', 'Access with bigger drops', 'VIP-only events'],
    featured: true
  }, {
    name: 'Elite Lounge',
    price: '$55',
    ...
    perks: ['All VIP Lounge perks', 'Priority support', 'Exclusive experience', 'All access pass']
  }];
  const testimonials = [{
    name: 'Eleanor Vance',
    role: 'VIP Member',
    quote: 'Joining the VIP Lounge completely transformed my daily routine. The exclusive recipes and community support are unparalleled.',
    rating: 5
  }, {
    name: 'Marcus Chen',
    role: 'Elite Member',
    quote: 'The Elite experience is exactly that—elite. Priority support and early access to drops make every penny worth it.',
    rating: 5
  }];
  const faqs = [{
    question: 'What is included in the membership?',
    answer: 'Memberships include access to exclusive content, behind-the-scenes updates, community forums, and depending on your tier, special discounts and VIP events.'
  }, {
    question: 'Can I upgrade or downgrade my plan?',
    answer: 'Absolutely. You can change your membership tier at any time from your account dashboard. Changes take effect at the start of your next billing cycle.'
  }, {
    question: 'Is there a commitment period?',
    answer: 'No, all our memberships are billed monthly and you can cancel at any time without penalty.'
  }];
  const fadeInUp = {
    initial: {
      opacity: 0,
  ...
  return <>
      <Helmet>
        ...
        <meta name="description" content="Join the exclusive Apple Jucy Members Portal for premium content, expert support, and a vibrant community." />
      </Helmet>
      ...
      <div className="min-h-screen bg-background selection:bg-primary/20 selection:text-primary">
        ...
        <section id="home" className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1617213226302-99a82b62626f?q=80&w=2070&auto=format&fit=crop" alt="Luxury aesthetic background" className="w-full h-full object-cover opacity-[0.15] mix-blend-multiply" />
          ...
          <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
            ...
            delay: 0.3
              ...
              Welcome to <br /><span className="font-medium">Apple Jucy Memberships</span>
            </motion.h1>
            <motion.p initial={{
            opacity: 0,
            y: 20
            ...
            delay: 0.5
              ...
              Discover a world of refined taste, exclusive content, and a community that shares your passion for the extraordinary.
            </motion.p>
            <motion.div initial={{
            opacity: 0,
            y: 20
            ...
            delay: 0.7
              ...
              <Button size="lg" onClick={() => document.getElementById('membership').scrollIntoView({
              behavior: 'smooth'
              ...
              <Link to="/login" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="rounded-full px-8 h-14 text-base border-border hover:bg-secondary w-full sm:w-auto">
                  Member Sign In
                </Button>
              </Link>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <motion.div {...fadeInUp} className="order-2 md:order-1">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/5]">
                  <img src="https://horizons-cdn.hostinger.com/c5220234-8448-43ff-be7f-d4df3f730b12/9-fMk9l.png" alt="Elegant lifestyle" className="w-full h-full object-cover" />
              ...
              <motion.div {...fadeInUp} className="order-1 md:order-2 space-y-6">
                ...
                <p className="text-foreground/70 text-lg font-light leading-relaxed">
                  My membership portal is designed to provide you with unparalleled access to my most naughtiest behind-the-scenes, and a slew of naughty-shorts, png's,  stickers yes they are edibles too .
                </p>
                <div className="pt-4">
                  <Link to="/products" className="inline-flex items-center text-primary font-medium hover:text-primary/80 transition-colors group">
                    Discover tiers 
        ...
        <div className="container mx-auto px-6"><div className="h-px w-full bg-border/50"></div></div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center">
              ...
              delay: index * 0.1
                  ...
                  <Card className={`relative h-full flex flex-col transition-all duration-500 rounded-2xl border-border/50 ${tier.featured ? 'bg-card shadow-2xl scale-100 md:scale-105 z-10 border-primary/20' : 'bg-card/50 shadow-lg hover:shadow-xl hover:-translate-y-1'}`}>
                    {tier.featured && <div className="absolute -top-4 left-0 right-0 flex justify-center">
                    ...
                    <CardHeader className="text-center pt-10 pb-6">
                      <CardTitle className="text-xl font-medium text-foreground mb-2">{tier.name}</CardTitle>
                      ...
                      <p className="text-sm text-foreground/60 mt-4 font-light">{tier.description}</p>
                    </CardHeader>
                    
                    <CardContent className="flex-grow flex flex-col px-8 pb-10">
                      <ul className="space-y-4 mb-8 flex-grow">
                        {tier.perks.map((perk, i) => <li key={i} className="flex items-start text-sm text-foreground/80 font-light">
                      ...
                      <Link to="/upgrade" className="block mt-auto">
                        <Button className={`w-full rounded-full h-12 ${tier.featured ? 'bg-primary hover:bg-primary/90 text-primary-foreground' : 'bg-secondary hover:bg-secondary/80 text-secondary-foreground'}`}>
                          Choose Plan
                        </Button>
                      </Link>
                    </CardContent>
          ...
          <div className="container mx-auto max-w-3xl">
            ...
            <motion.div {...fadeInUp}>
              <Accordion type="single" collapsible className="w-full">
                {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border-border/50 py-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
              <div className="md:col-span-2">
                ...
                <p className="text-background/60 font-light max-w-sm leading-relaxed">
                  Elevating the standard of wellness through curated experiences, premium products, and an exclusive community.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-background/60 font-light text-sm">
                  <li><a href="mailto:support@applejucy.com" className="hover:text-white transition-colors">support@applejucy.com</a></li>
                  <li>New York, NY</li>
                </ul>
              </div>
            </div>
