        ...
        <main className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="flex flex-col">
              ...
              {product.description && (
                <div
                  className="prose prose-orange mb-8 text-gray-600 leading-relaxed"
              ...
              <div className="mt-auto space-y-6 pt-8 border-t border-gray-100">
                ...
                {product.variants && product.variants.length > 1 && (
                  <div className="space-y-3">
                    <label className="block text-sm font-medium text-gray-900">Select Option</label>
                    <Select
                      value={selectedVariant?.id}
                      onValueChange={(val) =>
                        setSelectedVariant(product.variants.find((v) => v.id === val))
                      }
                    >
